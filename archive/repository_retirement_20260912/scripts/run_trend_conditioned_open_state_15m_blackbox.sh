...
python3 scripts/run_trend_conditioned_open_state_15m_blackbox_local.py \
  ...
  --receipt-out docs/research/local_trend_conditioned_open_state_15m_blackbox_receipt_v1.json
